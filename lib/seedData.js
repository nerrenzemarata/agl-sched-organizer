// Initial data, ported from the original static schedule. Photos live in /public/members.
// Everything here is only the *seed* — once the app runs, all edits are saved to localStorage.
export const SEED_MEMBERS = [
  { id: 'alec', name: 'Alec', color: '#6366F1', exact: true, photo: '/members/alec.jpg' },
  { id: 'carl', name: 'Carl John Monteros', color: '#DB8B0B', exact: false, photo: '/members/carl.jpg' },
  { id: 'dominic', name: 'Dominic', color: '#E0398A', exact: true, photo: '/members/dominic.jpg' },
  { id: 'jeremy', name: 'Jeremy Silao', color: '#0F9E8E', exact: true, photo: '/members/jeremy.jpg' },
  { id: 'jhury', name: 'Jhury Louie', color: '#8347E8', exact: false, photo: '/members/jhury.jpg' },
  { id: 'john', name: 'John Andrie', color: '#0B8FCC', exact: true, photo: '/members/john.jpg' },
];
